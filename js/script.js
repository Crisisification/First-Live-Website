...
(function($) {
  ...
  THEMEMASCOT.isLTR = {
	...
	// Testimonial slider area start here ***
	var swiper = new Swiper(".project__slider__one", {
		loop: "true",
		spaceBetween: 28,
		speed: 500,
		autoplay: {
	...
	//Services Carousel
	if ($('.services-four-carousel').length) {
		$('.services-four-carousel').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 30,
			nav: true,
	...
	//Services Carousel
	if ($('.services-six-carousel').length) {
		$('.services-six-carousel').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 30,
			nav: true,
	...
	// News Carousel
	if ($('.news-carousel-one').length) {
		$('.news-carousel-one').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			autoplay:true,
			loop: true,
			margin: 30,
